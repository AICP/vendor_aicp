...
# AICP permissions
PRODUCT_COPY_FILES += \
    vendor/aicp/config/permissions/privapp-permissions-aicp-system.xml:$(TARGET_COPY_OUT_SYSTEM_ETC)/permissions/privapp-permissions-aicp.xml \
    vendor/aicp/config/permissions/privapp-permissions-aicp-system-ext.xml:$(TARGET_OUT_SYSTEM_EXT_ETC)/permissions/privapp-permissions-aicp-ext.xml \
    vendor/aicp/config/permissions/privapp-permissions-aicp-product.xml:$(TARGET_COPY_OUT_PRODUCT_ETC)/permissions/privapp-permissions-aicp.xml
