...
*Note: Our xda thread template provides general instructions that are sufficent for some devices, however it may not be correct for your device, so make sure you change it to provide the proper instructions.*
