...
################################
# Copies the font configuration file into system/etc for the product as fonts_customization.xml.
...
AOSP_FONTS_FILE := vendor/aicp/prebuilt/common/etc/fonts_customization.xml
