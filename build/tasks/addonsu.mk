ADDONSU_PREBUILTS_PATH := vendor/aicp/addonsu/

ADDONSU_INSTALL_OUT := $(PRODUCT_OUT)/addonsu-install/
ADDONSU_INSTALL_TARGET := $(PRODUCT_OUT)/addonsu-$(AICP_VERSION_MAJOR).$(AICP_VERSION_MINOR)-$(TARGET_ARCH).zip
...
ADDONSU_REMOVE_TARGET := $(PRODUCT_OUT)/addonsu-remove-$(AICP_VERSION_MAJOR).$(AICP_VERSION_MINOR)-$(TARGET_ARCH).zip
